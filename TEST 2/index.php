...
$domainName = "Benefit Checker Help";

include_once('config-medicare.php');
?>
...
<body>
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        <h1 class="font-black text-center break-normal text-base md:text-2xl mx-auto">
            Seniors: 2024 Medicare Advantage Plans Can Help You Save Thousands In Additional Benefits. Check Your Eligibility Now
        </h1>
        </h1>
        <img class="mx-auto my-2 w-full" src="<?php echo $cdnPath; ?>C:\Users\kmiro\OneDrive\Escritorio\TEST 2\assets\images\hero1.png" />
        <p class="my-2 md:text-xl">
        Millions of Seniors are rushing the hotlines to secure their 2024 Medicare Advantage benefit.
        </p>
        <p class="my-2 md:text-xl">
        Benefit plans and options are always changing, so speak to our licensed sales agents and choose the right Medicare Advantage plan before enrollment ends!
        </p>
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                    ...
                    <button id="btn-2" class="flex justify-center bg-blue-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-blue-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">64
                        - 75
                    </button>
                    <button id="btn-3" class="flex justify-center bg-blue-500 hover:bg-blue-500  tracking-wide text-white font-bold rounded-2xl md:w-3/4 w-1/2 mx-auto border-b-2 border-blue-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center"> Over 
                        75
            ...
            <div id="display2" class="md:mt-8 mt-4 hidden">
                <h3 class="font-bold text-center md:text-4xl text-3xl my-8">
                    Are You Enrolled In Medicare Part A Or B?
                </h3>
                <div class="grid grid-cols-1 gap-6">
  ...
  <div id="display3" class="md:mt-8 mt-4 hidden">
    ...
    <div class=" border-white-500 mt-4  text-center ">

            <h3 class="text-xl text-green-500 md:text-2xl font-bold">
                Congratulations!
            </h3>
            <p class="mt-2 md:text-sm text-xs capitalize font-bold">You may be eligible for additional benefits and saving that may include:
            </p>
            <ul>
                <li>&check; Dental Hearing and Vision Care</li>
        ...
        <p class="text-base my-4"><span style="background-color:yellow;">Make a <b>quick call</b> to our licensed sales agents to learn more before enroll</p>
            <div id="countdown" class="w-max px-6 py-2 mx-auto">
                <span class="text-red-500">[xx:xx]]</span>
            </div>
        </div>
    </div>
